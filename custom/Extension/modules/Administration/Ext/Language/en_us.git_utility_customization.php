 ...
 ******************************************************************************************/ 
$mod_strings['LBL_SYSTEM_CUSTOMIZATION_TITLE'] = 'GIT Utility';
$mod_strings['LBL_GIT_UTILITY'] = 'GIT Commit';
$mod_strings['LBL_GIT_PR'] = 'Create Pull Request';
$mod_strings['LBL_GIT_VIEW_PR'] = 'View/Merge Pull Requests';
$mod_strings['LBL_DB_UTILITY'] = 'Database Changes';
$mod_strings['LBL_GIT_UTILITY_DESC'] = 'Review and commit system changes into a git repository';
$mod_strings['LBL_GIT_PR_DESC'] = 'Review commits and create a pull request to push changes into production';
$mod_strings['LBL_GIT_PR_VIEW_DESC'] = 'Review pull requests and merge into production repository';
$mod_strings['LBL_DB_UTILITY_DESC'] = 'Use to see database recent tables modified';